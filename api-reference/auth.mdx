...
If you have accidentally shared an API Key publicly, you can revoke it in the [Account Settings](https://app.rootkey.ai/settings/dev) of your ROOTKey user account by clicking the X button beside the key.
</Warning>