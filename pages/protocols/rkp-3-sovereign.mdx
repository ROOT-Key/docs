...
ROOTKey API (OVH - EU jurisdiction)
        ...
        │
        └──► Critical event path:
             Blockchain anchor → EBSI
             └── Operated by European Commission + EU member states
             └── EU legal jurisdiction
             └── Verifiable via EBSI explorer

  All components within EU legal jurisdiction.
  No data or proof subject to non-EU law at any stage.
```
