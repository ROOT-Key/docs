...
(OVH - EU jurisdiction)
        ...
        │
        └──► Blockchain anchor → EBSI (European Blockchain Services Infrastructure)
                    │                └── Operated by EU member states
                    │                └── EU jurisdiction
                    └──► Independently verifiable via EBSI explorer
                         (no ROOTKey cooperation required)

  No component outside EU legal jurisdiction.
```
