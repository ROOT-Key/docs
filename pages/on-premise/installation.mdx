...
<Steps>
  ...
  <Step title="Load the TLS certificate into the cluster">
    ...
    In Scenario C the namespace does not exist until the install creates it — run this step after the first install pass, or create the namespace by hand first.
  </Step>
...
| 7 | `deploy` | Deploys the Data Plane umbrella — all 26 workloads. |
