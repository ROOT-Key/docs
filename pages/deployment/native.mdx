...
```
Enterprise Platform (CRM / ERP / DMS / Operational Tool)
┌──────────────────────────────────────────────────────┐
│                                                      │
│   Platform Workflow / Event Trigger                  │
│   (record created, document approved, data modified) │
│         │                                            │
│         ▼                                            │
│   ROOTKey Integration Layer                          │
│   (native plugin / webhook / embedded connector)     │
│         │                                            │
└─────────┼────────────────────────────────────────────┘
          │ API call (internal or outbound)
          ▼
    ROOTKey REST API
          │
          ▼
    Protocol Processing + Blockchain Anchoring
```
