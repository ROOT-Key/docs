...
The technical installation guide covers everything an integrator or an internal platform team needs to install and run the Data Plane: requirements, the step-by-step install, the full configuration reference, verification, day-two operations, and every failure mode we have seen on a real installation.

<CardGroup cols={2}>
  <Card title="On-Premise Installation" icon="server" href="/pages/on-premise/overview">
    Start here. What gets installed, choosing a scenario, and choosing a connectivity mode.
  </Card>
  <Card title="Requirements" icon="clipboard-check" href="/pages/on-premise/requirements">
    Hardware, operating system, network, PostgreSQL, DNS and TLS — everything to have ready first.
  </Card>
</CardGroup>
