...
| Property | Value |
|----------|-------|
| Distribution format | Docker images + Helm charts |
| Image registry | XXX |
| Minimum Kubernetes version | XXX |
| Minimum CPU (per node) | XXX |
| Minimum RAM (per node) | XXX |
| Storage requirement | XXX |
| Horizontal scaling | Supported |
| Rolling updates | Supported |
| Health probes | Liveness and readiness endpoints available |
